...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-gray-900 data-[state=checked]:text-blue-900 data-[highlighted]:text-blue-900",
      "focus:bg-blue-100 focus:text-blue-900 data-[highlighted]:bg-blue-50",
  ...
  >
    ...
    <SelectPrimitive.ItemText 
      className="text-gray-900 data-[state=checked]:text-blue-900 data-[highlighted]:text-blue-900"
      style={{ color: '#111827' }}
    >
      {children}
    </SelectPrimitive.ItemText>
