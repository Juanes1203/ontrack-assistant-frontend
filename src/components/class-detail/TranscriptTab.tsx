        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <Textarea
              ...
              className={`min-h-[400px] border border-gray-300 focus:border-blue-400 text-base leading-relaxed text-gray-600 font-medium placeholder:text-gray-400 bg-white ${
